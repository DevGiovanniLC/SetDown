...
function ActionGroup() {
    ...
    const baseChipClass = "h-10 w-10 cursor-pointer rounded-lg border transition-all duration-200 hover:-translate-y-0.5 flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-200 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950";
    const idleChipClass = "bg-zinc-800/85 border-zinc-700 text-zinc-200 hover:bg-zinc-700";
